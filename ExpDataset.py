...
class MustardDataset(Dataset):
    ...
    def __init__(self, datatye):
        ...
        if self.datatye == 'train':
            datafile = 'D:\Project_Design\Dataset\Main\mustard-dataset-train.csv'
            need_remove = ['2_131', '2_149', '2_196', '2_202', '2_264', '2_306', '2_312', '2_323', '2_356', '2_373', '2_393']
        elif self.datatye == 'dev':
            datafile = 'D:\Project_Design\Dataset\Main\mustard-dataset-dev.csv'
            need_remove = ['2_536', '2_540', '2_549', '2_552', '2_58', '2_430', '2_434', '2_445', '2_441']
        elif self.datatye == 'test':
            datafile = 'D:\Project_Design\Dataset\Main\mustard-dataset-test.csv'
    ...
    def __getitem__(self, index):
        ...
        # 获取文本特征
        textPath = \
            "D:\\Project_Design\\QEBSAN\\QEBSAN\\token\\mustard\\txt_final\\" + self.datatye + "\\" + uttName+"\\"
        textFea = [np.loadtxt(
        ...
        # 获取图像特征
        imagePath = "D:\\Project_Design\\QEBSAN\\QEBSAN\\token\\mustard\\img\\" + self.datatye + "\\"+uttName+"\\"
        imageFea = [np.loadtxt(
        ...
        # 获取音频特征
        context_audioPath = "D:\\Project_Design\\QEBSAN\\QEBSAN\\token\\mustard\\audio_final\\" + self.datatye + "\\context" + "\\" + uttName + ".txt"    #3 128
        target_audioPath = "D:\\Project_Design\\QEBSAN\\QEBSAN\\token\\mustard\\audio_final\\" + self.datatye+ "\\target"  + "\\" + uttName + ".txt"      #  128
        # auFea = [np.loadtxt(
