...
LastEditTime: 2024-04-09 01:06:39
'''
import torch
import numpy as np
...
def predict():
    ...
    # 加载音频特征
    context_audioPath = "out_audioFea\\au_context.txt"
    target_audioPath = "out_audioFea\\au_target.txt"
    ...
    q_model = torch.load(f'QFNN-main\QFNN-main\Quantum_result\state\qModel100.pt')
    q_model.eval()
