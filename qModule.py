...
def trainEval():
    ...
    stateSavePATH = f'Quantum_result/state/{all_epochs}_Epochs_{now}/state.pt'
    modelSavePATH = f'Quantum_result/state/{all_epochs}_Epochs_{now}/model.pt'
    ...
    # 与训练队的分类模型
    class_model=torch.load('result/state/80_Epochs_2024-03-08-22-10-37/model.pt')
    class_model.eval()
